(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/BehaviorSubject'), require('rxjs/add/observable/fromEvent'), require('@kaltura-ng/kaltura-common'), require('rxjs/Subject'), require('jquery'), require('rxjs/Observable'), require('rxjs/add/observable/forkJoin'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/share'), require('rxjs/add/operator/map'), require('rxjs/ReplaySubject'), require('rxjs/add/observable/of'), require('rxjs/add/operator/catch'), require('rxjs/add/operator/do'), require('moment'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@kaltura-ng/kaltura-ui', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/BehaviorSubject', 'rxjs/add/observable/fromEvent', '@kaltura-ng/kaltura-common', 'rxjs/Subject', 'jquery', 'rxjs/Observable', 'rxjs/add/observable/forkJoin', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/share', 'rxjs/add/operator/map', 'rxjs/ReplaySubject', 'rxjs/add/observable/of', 'rxjs/add/operator/catch', 'rxjs/add/operator/do', 'moment', '@angular/platform-browser'], factory) :
    (global = global || self, factory((global['kaltura-ng'] = global['kaltura-ng'] || {}, global['kaltura-ng']['kaltura-ui'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.rxjs.BehaviorSubject, global.rxjs['add/observable/fromEvent'], global.kalturaCommon, global.rxjs.Subject, global.$NS, global.rxjs.Observable, global.rxjs['add/observable/forkJoin'], global.rxjs['add/operator/mergeMap'], global.rxjs['add/operator/share'], global.rxjs['add/operator/map'], global.rxjs.ReplaySubject, global.rxjs['add/observable/of'], global.rxjs['add/operator/catch'], global.rxjs['add/operator/do'], global.momentNS, global.ng.platformBrowser));
}(this, (function (exports, core, common, forms, BehaviorSubject, fromEvent, kalturaCommon, Subject, $NS, Observable, forkJoin, mergeMap, share, map, ReplaySubject, of, _catch, _do, momentNS, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AreaBlockerComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('areaBlockerContainer', { static: false }),
            __metadata("design:type", core.ElementRef)
        ], AreaBlockerComponent.prototype, "areaBlockerContainer", void 0);
        __decorate([
            core.ViewChild('spinnerContainer', { static: false }),
            __metadata("design:type", core.ElementRef)
    ...
    var DetailsBarComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChildren(DetailInfoComponent),
        ...
        __decorate([
            core.ViewChild('dataPanel', { static: true }),
            __metadata("design:type", core.ElementRef)
        ], DetailsBarComponent.prototype, "dataPanel", void 0);
        __decorate([
            core.ViewChild('dataWrapper', { static: true }),
            __metadata("design:type", core.ElementRef)
                ...
                dynamicControls.forEach(function (formControl) {
                    if (!config.ignoreMultiple && formControl.allowMultiple) {
                        ...
                        if (formControl instanceof DynamicSectionControl) {
                            ...
                            result[formControl.key] = new forms.FormControl(formControl.defaultValue || null, { validators: formControl.validators, updateOn: formControl.validateOn ? formControl.validateOn : 'change' });
                        }
                    }
                });
            }
            return (result instanceof forms.FormGroup) ? result : this._formBuilder.group(result);
        };
    ...
    var DynamicFormItem = /** @class */ (function () {
        ...
        DynamicFormItem.prototype.ngOnInit = function () {
            ...
            if (this.control.validators) {
                var RequiredValidator = validators.find(function (validator) {
                    return validator == forms.Validators.required;
                });
        ...
        DynamicFormItem = __decorate([
            ...
            __metadata("design:paramtypes", [forms.FormBuilder, DynamicFormService])
        ], DynamicFormItem);
    ...
    var PopupWidgetComponent = /** @class */ (function () {
        function PopupWidgetComponent(popup, renderer) {
            ...
            this._statechange = new BehaviorSubject.BehaviorSubject({ state: '' });
        ...
        __decorate([
            core.HostListener('window:popstate', ['$event']),
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [Object]),
            __metadata("design:returntype", void 0)
    ...
    var KalturaPlayerComponent = /** @class */ (function () {
        function KalturaPlayerComponent() {
            ...
            this.lazy = false;
            this.id = "";
            this.kalturaPlayerReady = new core.EventEmitter();
        }
    ...
    var StickyScrollService = /** @class */ (function () {
        function StickyScrollService() {
            this._scrollSubject = new Subject.Subject();
            this.scrollStatus$ = this._scrollSubject.asObservable();
            this._resizeSubject = new Subject.Subject();
            this.resizeStatus$ = this._resizeSubject.asObservable();
            this._layoutSubject = new BehaviorSubject.BehaviorSubject({});
    ...
    var StickyDirective = /** @class */ (function () {
        function StickyDirective(elementRef, renderer, _stickyScrollService) {
            ...
            this.onStickyEvent = new core.EventEmitter();
            this.onUnStickyEvent = new core.EventEmitter();
            this.scrollOffset = 0;
            this.stickyId = "";
            this.sticksTo = "";
        ...
        StickyDirective.prototype.ngOnInit = function () {
            ...
            this._stickyScrollService.scrollStatus$.pipe(kalturaCommon.cancelOnDestroy(this)).subscribe(function (event) {
                // console.log(`[${this.stickyId}] - handle scroll`);
                _this._render();
            });
            this._stickyScrollService.resizeStatus$.pipe(kalturaCommon.cancelOnDestroy(this)).subscribe(function (event) {
                _this.onResize();
            });
            this._stickyScrollService.layoutSubject$.pipe(kalturaCommon.cancelOnDestroy(this)).subscribe(function (elements) {
        ...
        StickyDirective = __decorate([
            ...
            __metadata("design:paramtypes", [core.ElementRef, core.Renderer2, StickyScrollService])
        ], StickyDirective);
    ...
    var StickyComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('contentWrapper', { static: true }),
            __metadata("design:type", core.ElementRef)
        ], StickyComponent.prototype, "content", void 0);
        __decorate([
            core.ViewChild('stickyDiv', { static: true }),
            __metadata("design:type", core.ElementRef)
        ], StickyComponent.prototype, "stickyDiv", void 0);
        __decorate([
            core.ViewChild(StickyDirective, { static: true }),
        ...
        StickyComponent = __decorate([
            ...
            __metadata("design:paramtypes", [StickyScrollService, core.Renderer2])
        ], StickyComponent);
    ...
    var StickyModule = /** @class */ (function () {
        ...
        StickyModule = StickyModule_1 = __decorate([
            core.NgModule({
                imports: [
                    kalturaCommon.KalturaCommonModule
                ],
                declarations: [
                    StickyComponent,
                    StickyDirective
    ...
    var TagsComponent = /** @class */ (function () {
        function TagsComponent() {
            ...
            this.onTagRemove = new core.EventEmitter();
            this.onRemoveAll = new core.EventEmitter();
            this.onTagsChange = new core.EventEmitter();
            this._showMore = false;
        ...
        __decorate([
            core.ViewChild('scroller', { static: false }),
            __metadata("design:type", core.ElementRef)
    ...
    })(exports.OnDataSavingReasons || (exports.OnDataSavingReasons = {}));
    var WidgetsManagerBase = /** @class */ (function () {
        function WidgetsManagerBase(logger) {
            this._widgets = [];
            this._widgetsState = new BehaviorSubject.BehaviorSubject({});
            this._isNewData = false;
            this.widgetsState$ = this._widgetsState.asObservable();
            this._logger = logger ? logger.subLogger("widgetsManager") : new kalturaCommon.EmptyLogger();
        }
        ...
        WidgetsManagerBase.prototype.notifyDataSaving = function (newData, request, originalData) {
            ...
            return Observable.Observable.of(isAttachedWidgetBusy ?
                {
                    ready: false,
                    reason: exports.OnDataSavingReasons.attachedWidgetBusy
                } : { ready: true })
                .pipe(kalturaCommon.cancelOnDestroy(this))
                .flatMap(function (response) {
                if (response.ready) {
                    return _this._validateWidgets()
                        .catch(function (error, caught) { return Observable.Observable.of({ isValid: false }); })
                        .map(function (response) { return response.isValid ? { ready: true } : {
                        ready: false,
                        reason: exports.OnDataSavingReasons.validationErrors
                    }; });
                }
                else {
                    return Observable.Observable.of(response);
                }
            })
                ...
                if (response.ready) {
                    ...
                    if (saveContent.errors.length === 0) {
                        ...
                        return {
                            ready: false,
                            reason: exports.OnDataSavingReasons.buildRequestFailure,
        ...
        WidgetsManagerBase.prototype._validateWidgets = function () {
            ...
            var widgetsResults = widgets.map(function (widget) {
                return widget._validate()
                    .pipe(kalturaCommon.cancelOnDestroy(_this))
                    .catch(function (err, caught) { return Observable.Observable.of({ isValid: false }); });
            });
            if (widgetsResults.length) {
                return Observable.Observable.forkJoin.apply(Observable.Observable, __spread(widgetsResults)).map(function (responses) {
                    return responses.find(function (response) { return !response.isValid; }) || { isValid: true };
                });
            }
            else {
                return Observable.Observable.of({ isValid: true });
            }
        };
    ...
    var WidgetBase = /** @class */ (function () {
        function WidgetBase(_key, logger) {
            ...
            this._dataSource = new ReplaySubject.ReplaySubject(1);
            ...
            this._widgetReset = new Subject.Subject();
            ...
            this._logger = logger ? logger.subLogger("widgets." + _key) : new kalturaCommon.EmptyLogger();
        }
        ...
        WidgetBase.prototype.activate = function () {
            ...
            if (this.data && this.isAttached && !this.isActive) {
                ...
                if (activate$ instanceof Observable.Observable) {
                    ...
                    this._activateSubscription = activate$
                        .catch(function (error, caught) { return Observable.Observable.of({ failed: true, error: error }); })
    ...
    exports.AreaBlockerComponent = AreaBlockerComponent;
    exports.AreaBlockerMessage = AreaBlockerMessage;
    exports.AreaBlockerModule = AreaBlockerModule;
    exports.AutofocusDirective = AutofocusDirective;
    exports.DatePickerControl = DatePickerControl;
    exports.DatePipe = DatePipe;
    exports.DetailInfoComponent = DetailInfoComponent;
    exports.DetailsBarComponent = DetailsBarComponent;
    exports.DetailsBarModule = DetailsBarModule;
    exports.DynamicDropdownControl = DynamicDropdownControl;
    exports.DynamicFormControlBase = DynamicFormControlBase;
    ...
    exports.DynamicSectionControl = DynamicSectionControl;
    exports.FileDialogComponent = FileDialogComponent;
    exports.FileSizePipe = FileSizePipe;
    exports.InputHelperComponent = InputHelperComponent;
    exports.InputHelperModule = InputHelperModule;
    exports.InputRangeComponent = InputRangeComponent;
    exports.InputRangeModule = InputRangeModule;
    exports.KTooltipDirective = KTooltipDirective;
    exports.KalturaBrowserUtils = KalturaBrowserUtils;
    exports.KalturaPlayerComponent = KalturaPlayerComponent;
    exports.KalturaUIModule = KalturaUIModule;
    exports.KalturaValidators = KalturaValidators;
    exports.LineBreakPipe = LineBreakPipe;
    exports.ListControl = ListControl;
    exports.NumberControl = NumberControl;
    exports.PopupWidgetComponent = PopupWidgetComponent;
    exports.PopupWidgetModule = PopupWidgetModule;
    exports.PopupWidgetStates = PopupWidgetStates;
    exports.SafePipe = SafePipe;
    exports.ScrollToTopContainerComponent = ScrollToTopContainerComponent;
    exports.StickyComponent = StickyComponent;
    exports.StickyDirective = StickyDirective;
    exports.StickyModule = StickyModule;
    exports.StickyScrollService = StickyScrollService;
    ...
    exports.WidgetsManagerBase = WidgetsManagerBase;
    exports.ipRegex = ipRegex;
    exports.urlHttpRegex = urlHttpRegex;
    exports.urlRegex = urlRegex;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=kaltura-ng-kaltura-ui.umd.js.map
